...
/**
 * Created by Caffrey on 2017/4/24.
 */
public class HuffmanCode {
    public static void main(String[] args)
    {
        ...
        java.util.StringTokenizer token = new java.util.StringTokenizer(text," ",true);
        ...
        for(int i=0;i<text.length();i++)
        {
            ...
            {
                System.out.print(codes[(int)text.charAt(i)]);
            }
        }
        System.out.println();
        System.out.printf("%-15s%-15s%-15s%-15s\n","ASCALL Code","Character","Frequency","Code");
